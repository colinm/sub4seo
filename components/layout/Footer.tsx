...
const serviceLinks = [
  ...
  { label: 'Patio Enclosures', href: '/patio' },
  { label: 'Triple Pane Windows', href: '/windows/krypton' },
]

const resourceLinks = [
  { label: 'Video Library', href: 'https://www.youtube.com/channel/UC-DSC5JfQoiXHf-nLXz0GWQ', external: true },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400 mb-4">
              Serving the Quad Cities area since 1985. Family owned and operated. Lifetime workmanship guarantee on every installation.
            </p>
      ...
      <div className="border-t border-white/10 py-4">
        <div className="max-w-7xl mx-auto px-4 flex flex-col sm:flex-row items-center justify-between gap-2 text-sm text-gray-500">
          ...
          <div className="flex gap-4">
            <Link href="/about/our-story" className="hover:text-gray-300 transition-colors">About</Link>
            <Link href="/contact" className="hover:text-gray-300 transition-colors">Contact</Link>
            <Link href="/resources/glossary" className="hover:text-gray-300 transition-colors">Glossary</Link>
            <Link href="/service-areas" className="hover:text-gray-300 transition-colors">Service Areas</Link>
          </div>
        </div>
      </div>
    </footer>

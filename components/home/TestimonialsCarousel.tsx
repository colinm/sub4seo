        ...
        <div className="text-center mb-12">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 bg-white border border-gray-200 rounded-lg px-4 py-2 shadow-sm hover:shadow-md transition-shadow text-sm font-medium text-gray-700"
            >
              <span className="text-xs font-extrabold border-2 border-[#006699] text-[#006699] rounded px-1 py-0.5 leading-none">BBB</span>
              <span><strong>A+</strong> BBB Rating</span>
            </a>
          </div>
        </div>

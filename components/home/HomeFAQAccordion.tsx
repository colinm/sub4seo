      ...
      <div className="max-w-4xl mx-auto px-4">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-600 text-lg">
            Common questions from Quad Cities homeowners about our products and services.
          </p>
        </div>

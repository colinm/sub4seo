...
export const pageSeoData: Record<string, PageSeoConfig> = {
  ...
  "/": {
    title:
      "Replacement Windows, Siding & Doors | Quad Cities General Contractor",
    description:
  ...
  "/windows/slider": {
    ...
    keywords: [
      "slider windows",
      "glider windows Quad Cities",
      "sliding windows Davenport IA",
    ],
  ...
  "/windows/bay-and-bow": {
    ...
    keywords: [
      "bay windows Quad Cities",
      "bow windows Davenport",
  ...
  "/windows/basement": {
    ...
    keywords: [
      "basement windows Quad Cities",
      "basement window replacement Davenport",
      "basement windows Iowa",
    ],
  ...
  "/windows/egress": {
    ...
    keywords: [
      "egress windows Quad Cities",
      "egress window installation Iowa",
      "basement egress Davenport",
    ],
  ...
  "/windows/window-options": {
    ...
    keywords: [
      "window options Quad Cities",
      "window upgrades Iowa",
      "window grids hardware",
    ],
  ...
  "/siding/steel-siding": {
    title:
      "Steel Siding Installation | Durable & Low Maintenance | Quad Cities",
    description:
  ...
  "/siding/composite-siding": {
    title:
      "Composite Siding | Cedar Look Without the Maintenance | Quad Cities",
    description:
  ...
  "/siding/siding-options": {
    ...
    keywords: [
      "siding options Iowa",
      "siding colors Quad Cities",
      "siding styles Davenport",
    ],
  ...
  "/doors/door-styles": {
    ...
    keywords: [
      "door styles Quad Cities",
      "entry doors Iowa",
      "storm doors Davenport IA",
    ],
  ...
  "/doors/storm": {
    ...
    description:
      "Larson storm doors from Suburban Construction open the full potential of your entry. Platinum Collection features security, convenience, and style for Quad Cities homes.",
    keywords: [
      "storm doors Quad Cities",
      "storm door installation Davenport",
      "Larson storm doors Iowa",
    ],
    canonicalPath: "/doors/storm",
    ogImage: "/main.jpg",
  },
  "/doors/easy-vent": {
  ...
  "/doors/mini-blinds": {
    ...
    keywords: [
      "door mini blinds",
      "built-in blinds door Quad Cities",
      "doors with blinds Iowa",
    ],
  ...
  "/patio": {
    ...
    keywords: [
      "patio enclosures Quad Cities",
      "patio awnings Iowa",
      "sunrooms Davenport IA",
    ],
    canonicalPath: "/patio",
    ogImage: "/main.jpg",
  },
  "/patio/patio-awning": {
    ...
    keywords: [
      "patio awnings Quad Cities",
      "awning installation Iowa",
      "retractable awnings Davenport",
    ],
  ...
  "/patio/solar-shades": {
    ...
    keywords: [
      "solar shades Quad Cities",
      "porch solar shades Iowa",
      "UV protection shades Davenport",
    ],
  ...
  "/patio/canopies": {
    ...
    keywords: [
      "canopies Quad Cities",
      "patio canopy Iowa",
      "outdoor canopy Davenport",
    ],
  ...
  "/about/meet-the-owners": {
    ...
    keywords: [
      "Suburban Construction owners",
      "family owned contractor Quad Cities",
    ],
  ...
  "/about/in-the-news": {
    ...
    keywords: [
      "Suburban Construction news",
      "home improvement news Quad Cities",
    ],
  ...
  "/about/referral-program": {
    ...
    keywords: [
      "Suburban Construction referral",
      "home improvement referral program Iowa",
    ],
  ...
  "/sent": {
    ...
    description:
      "Thank you for contacting Suburban Construction. We'll be in touch shortly.",
    canonicalPath: "/sent",
  },
  ...
  "/resources/faq": {
    ...
    keywords: [
      "home improvement FAQ Quad Cities",
      "window FAQ Iowa",
      "siding FAQ Davenport",
    ],
  ...
  "/resources/heater-cap-faq": {
    ...
    keywords: [
      "heater cap FAQ",
      "gutter heater Iowa",
      "ice dam prevention Quad Cities",
    ],
  ...
  "/resources/recommended": {
    ...
    keywords: [
      "window maintenance Iowa",
      "siding maintenance tips",
      "home maintenance Quad Cities",
    ],
  ...
  "/resources/warranty-information": {
    ...
    keywords: [
      "window warranty Iowa",
      "siding warranty Quad Cities",
      "lifetime guarantee home improvement",
    ],
  ...
  "/resources/support": {
    ...
    keywords: [
      "Suburban Construction support",
      "window repair Quad Cities",
      "home improvement support Iowa",
    ],

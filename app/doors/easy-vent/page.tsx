      ...
      <section className="py-12">
        <div className="max-w-5xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center mb-10">
            ...
            <Image src="/duel-vent.jpg" alt="Easy Vent storm door with dual ventilation panels open for fresh air" width={600} height={420} className="rounded-xl shadow-lg w-full h-auto object-cover" />
          </div>
      ...
      <section className="py-10 bg-gray-50">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              { title: 'Easy-Transition Screen', body: 'Drop-down or retractable design requires no seasonal panel changes.' },
              { title: 'Full-View Glass', body: 'Maximum glass area for light and visibility when screen is retracted.' },
              { title: 'Insect Screen', body: 'Keeps bugs out while allowing maximum airflow.' },
              { title: 'Winter Insulation', body: 'Adds an extra layer of insulation over your entry door in winter.' },
              { title: 'Security Layer', body: 'Secondary security layer — adds time and difficulty for forced entry attempts.' },
              { title: 'Multiple Frame Colors', body: 'Available in multiple frame colors to match your home\'s exterior.' },
              { title: 'Heavy-Gauge Aluminum', body: 'Heavy-gauge aluminum frame resists corrosion and warping.' },
              { title: 'Durable Hardware', body: 'Closer and latch hardware designed for long-term reliability.' },
            ].map((f) => (
      ...
      <section className="py-12">
        <div className="max-w-5xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            <Image src="/roll-screen.png" alt="Storm door with retractable screen shown in multiple positions" width={600} height={420} className="rounded-xl shadow-lg w-full h-auto object-cover" />
            <div>
              ...
              <ul className="space-y-4">
                {[
                  { name: 'Full-view', desc: 'maximum glass area for light and visibility' },
                  { name: 'Mid-view', desc: 'partial glass panel with decorative lower panel' },
                  { name: 'High-view', desc: 'glass panel in upper portion for privacy at door base' },
                  { name: 'Decorative grille options', desc: 'available on select models' },
                ].map((item) => (
        ...
        <div className="max-w-5xl mx-auto px-4">
          <div className="bg-accent-subtle border border-accent-faint rounded-xl p-6 flex flex-col sm:flex-row items-start sm:items-center gap-4">
            <div className="flex-1">
              <h3 className="text-lg font-bold text-gray-900 mb-1">Pair with a New Entry Door</h3>
              <p className="text-gray-700 leading-relaxed">
                Many homeowners upgrade both their entry door and storm door at the same time — and for
                good reason. A new entry door paired with an Easy Vent storm door gives you the complete
                package: exceptional curb appeal, maximum energy efficiency, and year-round weather protection.
              </p>
            </div>
            <Link href="/doors/entry" className="whitespace-nowrap bg-accent hover:bg-accent-hover text-white font-bold px-5 py-2.5 rounded transition-colors text-sm">
              View Entry Doors →
            </Link>
          </div>
        </div>

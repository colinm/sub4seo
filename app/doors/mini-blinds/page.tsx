      ...
      <section className="py-12">
        <div className="max-w-5xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center mb-10">
            ...
            <Image src="/mini-blinds.jpg" alt="Door with built-in mini blinds sealed between glass panes for dust-free light control" width={600} height={420} className="rounded-xl shadow-lg w-full h-auto object-cover" />
          </div>
      ...
      <section className="py-10 bg-gray-50">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              { title: 'Zero Dust', body: 'Blinds sealed between glass panes — zero dust accumulation.' },
              { title: 'Cord-Free Safety', body: 'No cords dangling — eliminates the safety hazard for young children.' },
              { title: 'Full Control', body: 'Blinds tilt open, tilt closed, or raise completely for full or partial privacy.' },
              { title: 'Clean Look', body: 'Clean, uncluttered look — no blind hardware to coordinate or replace.' },
              { title: 'Year-Round Use', body: 'Works in any season — no need to remove blinds for holiday decorating.' },
              { title: 'Multiple Door Styles', body: 'Available in steel and fiberglass door styles.' },
              { title: 'Insert Size Options', body: 'Available in a range of glass insert sizes and configurations.' },
              { title: 'Lifetime Guarantee', body: 'Professional installation with lifetime workmanship guarantee.' },
            ].map((f) => (
      ...
      <section className="py-12">
        <div className="max-w-5xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            <Image src="/mini-blinds.jpg" alt="Close-up of built-in mini blinds in door glass insert" width={600} height={420} className="rounded-xl shadow-lg w-full h-auto object-cover" />
            <div>
              ...
              <ul className="space-y-4">
                {[
                  { name: 'Patio doors', desc: 'control afternoon sun without covering the entire door opening' },
                  { name: 'Front entry doors', desc: 'with full-lite or half-lite glass inserts' },
                  { name: 'Back entry and mud room doors', desc: 'where privacy and light control are both needed' },
                  { name: 'Homes with pets or young children', desc: 'where cord-free operation is a safety priority' },
                ].map((item) => (
        ...
        <div className="max-w-5xl mx-auto px-4">
          <div className="bg-accent-subtle border border-accent-faint rounded-xl p-6 flex flex-col sm:flex-row items-start sm:items-center gap-4">
            <div className="flex-1">
              <h3 className="text-lg font-bold text-gray-900 mb-1">Browse Our Full Door Selection</h3>

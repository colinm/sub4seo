    ...
    <section className="py-24 min-h-[60vh] flex items-center">
      <div className="max-w-lg mx-auto px-4 text-center">
        ...
        <p className="text-gray-600 mb-8">
          ...
          <a href="tel:+15633914000" className="text-accent font-semibold hover:text-accent-dark">
            563-391-4000
          </a>{' '}
          or{' '}
          <a href="tel:+18007173066" className="text-accent font-semibold hover:text-accent-dark">
            1-800-717-3066
          </a>
          .
        </p>
        <Link
          href="/"
          className="inline-block bg-accent hover:bg-accent-hover text-white font-bold px-8 py-3 rounded transition-colors"
        >
          Back to Home
        </Link>
      </div>

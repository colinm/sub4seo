...
const faqCategories = [
  ...
  },
  {
    ...
    description:
      "How the Gutter Cap system works, how it compares, and what installation involves.",
    icon: "🌧️",
  },
  {
  ...
  },
  {
    ...
    description:
      "How the Heater Cap gutter system prevents ice dams and keeps gutters clear in winter.",
    icon: "❄️",
  },
  {
...
const generalFaqs = [
  {
    ...
    answer:
      "Suburban Construction was founded in 1985 by Brian D. Girskis in Bettendorf, Iowa. We have been serving the Quad Cities and surrounding areas for over 40 years, completing more than 40,000 installations.",
  },
  {
      ...
      <section className="py-12">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <p className="text-gray-600 leading-relaxed mb-8">
            Browse our topic-specific FAQ sections for detailed answers about
            each product or subject area.
          </p>
      ...
      <section className="py-12 bg-accent-subtle">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-gray-600 mb-6">
            Call us or stop by the showroom. We are happy to answer any
            questions about your specific situation with no pressure or
            obligation.
          </p>

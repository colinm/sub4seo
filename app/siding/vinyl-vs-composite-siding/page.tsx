              ...
              <tbody>
                {comparison.map((row, i) => (
                  ...
                  >
                    ...
                    <td className={`px-4 py-3 align-top ${row.winner === "vinyl" ? "font-semibold text-accent" : "text-gray-700"}`}>
                      {row.winner === "vinyl" && <span className="mr-1">✓</span>}
                      {row.vinyl}
                    </td>
                    <td className={`px-4 py-3 align-top ${row.winner === "composite" ? "font-semibold text-green-700" : "text-gray-700"}`}>

      ...
      <section className="py-12">
        <div className="max-w-5xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center mb-10">
            <div>
              ...
              <p className="text-gray-600 leading-relaxed mb-4">
                Vinyl siding is the most popular siding material in the United
                States — and it has earned that position by delivering
                exceptional value. It requires no painting, no caulking, no
                staining, and virtually no maintenance of any kind. A periodic
                washing with a garden hose is usually all it takes to keep it
                looking great for decades.
              </p>
              <p className="text-gray-600 leading-relaxed mb-4">
                Suburban Construction installs the Freedom Series vinyl siding
                line — the best combination of value, quality, and aesthetic
                variety in the market. Available in dozens of colors, multiple
                profiles, and several thickness grades to fit every budget and
                quality target.
              </p>
              <p className="text-gray-600 leading-relaxed">
                The color in vinyl siding is integral to the material — not
                painted on. That means it won&apos;t peel, chip, or blister the
                way painted wood does. Freedom Series uses an advanced copolymer
                compound with STAY-TRUE COLORS technology and UV stabilizers
                that maintain color significantly better than budget vinyl
                products, even in darker shades.
              </p>
            </div>
            <Image
              src="/vinyl.jpg"
              alt="Vinyl siding installed on home showing clean low-maintenance finish"
              width={600}
              height={420}
          ...
          <div className="grid grid-cols-2 gap-3">
            <Image
              src="/sidinghouse.jpg"
              alt="Home with new vinyl siding"
              width={300}
              height={220}
            ...
            <Image
              src="/siding1.png"
              alt="Vinyl siding profile detail"
              width={300}
              height={220}
              className="rounded-lg shadow-sm w-full h-40 object-cover"
            />
      ...
      <section className="py-10 bg-gray-50">
        <div className="max-w-5xl mx-auto px-4">
          <h2 className="text-2xl font-bold text-gray-900 mb-6 text-center">
            Freedom Series Features &amp; Benefits
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              {
                title: "No Maintenance",
                body: "No painting, caulking, or staining — ever. A hose-down is all it needs.",
              },
              {
                title: "STAY-TRUE COLORS",
                body: "Advanced copolymer compound with STAY-TRUE COLORS technology delivers superior color retention — choose darker shades with confidence.",
              },
              {
                title: '.046" Wall Thickness',
                body: 'Heavy-duty .046" thickness provides superior rigidity, ensuring straight, smooth walls.',
              },
              {
                title: "Double-Strength Nail Hem",
                body: "Resilient full-roll Double-Strength Nail Hem increases strength and bridges uneven wall surfaces.",
              },
              {
                title: "Secure Panel Locking System",
                body: "Interlocking Secure Panel Locking System secures panels in place for enhanced rigidity and stability.",
              },
              {
                title: "253 mph Wind Tested",
                body: "Laboratory tested to withstand windloads up to 253 mph — hurricane-force conditions.",
              },
              {
                title: '3/4" Lap Height',
                body: 'Attractive 3/4" lap height creates a deeper dimensional look with enhanced shadow lines.',
              },
              {
                title: "Moisture Resistant",
                body: "Impervious to rot, insects, and fungal growth that damage wood.",
              },
              {
                title: "Dozens of Colors",
                body: "Multiple profiles and palettes to match any home style.",
              },
              {
                title: "Insulated Option",
                body: "EPS foam-backed panels available for added R-value and rigidity.",
              },
              {
                title: "Lightweight",
                body: "Minimal structural stress — easier and faster to install correctly.",
              },
              {
                title: "Lifetime Non-Prorated Warranty",
                body: "Non-prorated, transferable lifetime warranty with lifetime fade and hail protection.",
              },
            ].map((f) => (
              <div
                key={f.title}
      ...
      <section className="py-12">
        <div className="max-w-5xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            <Image
              src="/siding-installation.png"
              alt="Vinyl siding profiles and installation on Quad Cities home"
              width={600}
              height={420}
              className="rounded-xl shadow-lg w-full h-auto object-cover"
            />
            <div>
              ...
              <ul className="space-y-4">
                {[
                  {
                    name: "Traditional Horizontal Lap",
                    desc: "Clean and classic — suits virtually every home style.",
                  },
                  {
                    name: "Dutch Lap",
                    desc: "A notch at the top of each course creates deeper shadow lines and texture.",
                  },
                  {
                    name: "Beaded Seam",
                    desc: "Elegant curved bottom bead for a more refined, historic look.",
                  },
                  {
                    name: "Vertical / Board & Batten",
                    desc: "Modern farmhouse look — great for accents or full facades.",
                  },
                  {
                    name: "Shake / Shingle",
                    desc: "Coastal or craftsman aesthetic, typically used on gable ends.",
                  },
                ].map((p) => (
          ...
          <div className="bg-accent-subtle border border-accent-faint rounded-xl p-6 flex flex-col sm:flex-row items-start sm:items-center gap-4">
            <div className="flex-1">
              <h3 className="text-lg font-bold text-gray-900 mb-1">
                Want More Energy Efficiency?
              </h3>
              <p className="text-gray-700 leading-relaxed">
                Upgrade to insulated vinyl siding — EPS foam backing adds
                R-value, reduces energy costs, and gives panels a thicker, more
      ...
      <section className="py-12 bg-accent-subtle">
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <p className="text-gray-600 mb-6">
            Contact us for a free vinyl siding estimate. Serving Davenport,
            Bettendorf, Moline, Rock Island, and the surrounding Quad Cities
            area.
          </p>
          <Link
            href="/contact"

...
export const metadata: Metadata = generatePageMetadata(pageSeoData['/about/referral-program'])
      ...
      <section className="py-12">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            At Suburban Construction, some of our best new customers come from the most trusted
            source there is: recommendations from people who have already worked with us. When a
            satisfied homeowner tells a friend or neighbor about their experience, it is the
            highest compliment we can receive.
          </p>
          <p className="text-gray-600 leading-relaxed mb-4">
            To show our appreciation, we have a referral program that rewards you when someone you
            refer completes a project with us. It is our way of saying thank you for helping us
            share what we do with the people you care about.
          </p>
          <p className="text-gray-600 leading-relaxed mb-8">
            Participating could not be simpler. Just let your friend or neighbor know about
            Suburban Construction and ask them to mention your name when they call. That is it.
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Share your experience with a friend, neighbor, co-worker, or family member who
                    could benefit from new windows, siding, doors, or gutters.
                  </p>
                </div>
              </li>
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    When your referral contacts Suburban Construction, they just need to mention
                    your name so we can credit you for the recommendation.
                  </p>
                </div>
              </li>
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Once your referral completes their home improvement project with us, you will
                    receive your referral reward. No complicated forms or tracking required.
                  </p>
                </div>
              </li>
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    We will be in touch to deliver your referral reward as a thank you for helping
                    us grow our Quad Cities family of happy homeowners.
                  </p>
                </div>
              </li>
            </ol>
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            Most of our referrals come from customers who genuinely want the people they care about
            to have the same positive experience they had. Common reasons customers recommend us:
          </p>
      ...
      <section className="py-12 bg-accent-subtle">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-gray-600 mb-6">
            Call us or have your friend or neighbor use our contact form. Just make sure they
            mention your name so we can credit you for the referral.
          </p>
          <Link
            href="/contact"

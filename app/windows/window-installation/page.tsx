      ...
      <section className="py-12">
        <div className="max-w-5xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center mb-10">
            ...
            <Image src="/install1.jpg" alt="Window installation crew removing old window from home" width={600} height={420} className="rounded-xl shadow-lg w-full h-auto object-cover" />
          </div>

          {/* Photo strip */}
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            <Image src="/install2.jpg" alt="New replacement window being set into rough opening during installation" width={300} height={220} className="rounded-lg shadow-sm w-full h-40 object-cover" />
            <Image src="/install3.jpg" alt="Window installer applying flashing and insulation around new window frame" width={300} height={220} className="rounded-lg shadow-sm w-full h-40 object-cover" />
            <Image src="/install4.jpg" alt="Finished replacement window installation with trim and exterior caulk applied" width={300} height={220} className="rounded-lg shadow-sm w-full h-40 object-cover" />
            <Image src="/install5.jpg" alt="Window installation in progress" width={300} height={220} className="rounded-lg shadow-sm w-full h-40 object-cover" />
          </div>
        </div>
      </section>
      ...
      <section className="py-10 bg-gray-50">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              { step: '1', title: 'Free In-Home Estimate & Measurement', body: 'We measure each opening, assess existing frames, and discuss your goals. No charge, no obligation.' },
              { step: '2', title: 'Custom Order', body: 'We place a custom order based on precise field measurements. Every window is made to order — not pulled from generic inventory.' },
              { step: '3', title: 'Scheduling & Preparation', body: 'We schedule installation at your convenience. You clear space around each opening; we bring all tools and materials.' },
              { step: '4', title: 'Removal of Old Windows', body: 'We carefully remove existing windows, minimizing disturbance to surrounding trim and siding. Old windows go directly into our disposal trailer.' },
              { step: '5', title: 'New Window Installation', body: 'Each window is shimmed level and plumb, fastened securely, flashed, and insulated. Tested for proper operation before moving on.' },
              { step: '6', title: 'Trim, Caulk & Final Seal', body: 'We reinstall or replace interior and exterior trim, apply exterior caulk at all perimeter joints, and perform a final inspection.' },
              { step: '7', title: 'Cleanup & Walkthrough', body: 'We vacuum sills, wipe glass, and clean up all debris. We walk you through each new window before we leave.' },
            ].map((f) => (
              <div key={f.step} className="bg-white rounded-lg border border-gray-200 p-4 shadow-sm">
      ...
      <section className="py-12">
        <div className="max-w-5xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            <Image src="/install5.jpg" alt="Window installation showing professional crew at work" width={600} height={420} className="rounded-xl shadow-lg w-full h-auto object-cover" />
            <div>
              ...
              <ul className="space-y-4">
                {[
                  { name: 'Experienced full-time installers', desc: 'not subcontractors — they install windows every day' },
                  { name: 'Proper flashing and insulation', desc: 'every opening sealed against water and air infiltration' },
                  { name: 'Complete cleanup and walkthrough', desc: 'we leave no mess and answer all your questions' },
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 mt-10">
            <Image src="/install6.jpg" alt="Window trim and caulk final seal" width={300} height={220} className="rounded-lg shadow-sm w-full h-40 object-cover" />
            <Image src="/install7.jpg" alt="Window installation cleanup" width={300} height={220} className="rounded-lg shadow-sm w-full h-40 object-cover" />
            <Image src="/install8.jpg" alt="Completed window installation" width={300} height={220} className="rounded-lg shadow-sm w-full h-40 object-cover" />
          </div>
        </div>
      </section>

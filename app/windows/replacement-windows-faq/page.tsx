...
const faqs: FAQItem[] = [
  ...
  {
    question: 'If I put new replacement windows in my house, will they improve my home\'s value?',
    answer:
  ...
  {
    question: 'What is more important for saving energy — the frame or the glass?',
    answer:

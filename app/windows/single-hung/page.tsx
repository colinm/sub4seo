        ...
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              { title: 'Classic Look', body: 'Suits traditional and craftsman-style homes perfectly.' },
              { title: 'Low-E Glass Options', body: 'Multiple Low-E glass options to improve energy efficiency.' },
              { title: 'Triple Pane Krypton', body: 'Triple pane krypton gas fill available for maximum insulation.' },

      ...
      <section className="py-12">
        <div className="max-w-5xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center mb-10">
            ...
            <Image src="/sliding-window1.jpg" alt="Sliding window installed in a home showing horizontal operation" width={600} height={420} className="rounded-xl shadow-lg w-full h-auto object-cover" />
          </div>

          {/* Photo strip */}
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
            <Image src="/sliding-window2.jpg" alt="Glider window providing wide panoramic view in living room" width={300} height={220} className="rounded-lg shadow-sm w-full h-40 object-cover" />
      ...
      <section className="py-10 bg-gray-50">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              { title: 'Smooth Operation', body: 'Horizontal operation is smooth and effortless — no heavy lifting.' },
              { title: 'Wide Openings', body: 'Perfect for wide openings where vertical sash windows are not practical.' },
              { title: 'Easy Cleaning', body: 'Sash removes from frame entirely for safe, easy exterior cleaning from inside.' },
              { title: 'High Reliability', body: 'Minimal mechanical parts mean greater long-term reliability.' },
              { title: 'Single or Double Slide', body: 'Available as single-slide or double-slide — one or both sashes move.' },
              { title: 'Triple Pane Available', body: 'Triple pane argon or krypton gas fill available for energy efficiency.' },
              { title: 'Color Selection', body: 'Wide color selection for frame exterior and interior finish.' },
              { title: 'Security & Screen', body: 'Multi-point locks and integrated screen for comfort and security.' },
            ].map((f) => (
      ...
      <section className="py-12">
        <div className="max-w-5xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            <Image src="/sliding-window2.jpg" alt="Glider window providing wide panoramic view" width={600} height={420} className="rounded-xl shadow-lg w-full h-auto object-cover" />
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-3">Great for Modern Home Designs</h2>
              ...
              <ul className="space-y-3">
                {[
                  { name: 'Learn more about triple pane krypton glass', href: '/windows/krypton' },
                  { name: 'See all window styles', href: '/windows/window-styles' },
                ].map((item) => (

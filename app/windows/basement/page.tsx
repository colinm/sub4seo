          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center mb-10">
            <div>
              ...
              <p className="text-gray-600 leading-relaxed mb-4">
                Basement windows are often the oldest and most neglected windows
                in the home. Original basement windows in many Quad Cities homes
                are single-pane glass set in steel or aluminum frames — a major
                source of heat loss in winter and moisture infiltration
                year-round. Replacing them with modern, properly insulated units
                is one of the most cost-effective improvements you can make to
                your home&apos;s energy envelope.
              </p>
              <p className="text-gray-600 leading-relaxed mb-4">
                Beyond energy performance, new basement windows improve the
                habitability of the space. More natural light makes a finished
                basement feel less like a cave and more like usable living
                space. Proper ventilation helps control humidity levels, which
                is critical in Iowa and Illinois where summer humidity can drive
                moisture into basements and create conditions favorable for
                mold.
              </p>
              <p className="text-gray-600 leading-relaxed">
                Suburban Construction installs basement replacement windows
                throughout Davenport, Bettendorf, Moline, Rock Island, and the
                surrounding area. We properly seal and insulate each
                installation to prevent future moisture issues — something that
                a quick DIY job rarely accomplishes.
              </p>
            </div>
            <Image
              src="/basement.png"
              alt="Basement replacement window installed with proper moisture sealing"
              width={600}
              height={420}
        ...
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              {
                title: "Vinyl Frames",
                body: "Modern vinyl frames eliminate the rust and condensation problems of old steel frames.",
              },
              {
                title: "Moisture Sealed",
                body: "Properly sealed installation prevents water infiltration at the frame perimeter.",
              },
              {
                title: "Multi-Pane Glass",
                body: "Multi-pane insulating glass dramatically improves thermal performance.",
              },
              {
                title: "Ventilation Option",
                body: "Operable vent option for fresh air circulation and humidity control.",
              },
              {
                title: "Multiple Configurations",
                body: "Available in hopper, slider, and fixed configurations.",
              },
              {
                title: "Code-Compliant Sizing",
                body: "Code-compliant sizing available for habitable room requirements.",
              },
              {
                title: "Lifetime Guarantee",
                body: "Lifetime workmanship guarantee on all installations.",
              },
            ].map((f) => (
              <div
                key={f.title}
      ...
      <section className="py-12">
        <div className="max-w-5xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            <Image
              src="/basement.jpg"
              alt="Egress window installation in basement"
              width={600}
              height={420}
              className="rounded-xl shadow-lg w-full h-auto object-cover"
            />
            <div>
              ...
              <p className="text-gray-600 leading-relaxed">
                If you&apos;re finishing your basement as a bedroom or habitable
                living space, you may be required by building code to install an
                egress window — a window large enough to serve as an emergency
                exit. We handle egress window installations including the
                excavation, window well, and proper drainage. See our{" "}
                <Link
                  href="/windows/egress"
          ...
          <div className="bg-accent-subtle border border-accent-faint rounded-xl p-6 flex flex-col sm:flex-row items-start sm:items-center gap-4">
            <div className="flex-1">
              ...
              <p className="text-gray-700 leading-relaxed">
                If your basement has a bedroom or habitable space, building code
                may require an egress window. We handle the complete
                installation including excavation and window well.
              </p>
            </div>
            <Link
              href="/windows/egress"
      ...
      <section className="py-12 bg-accent-subtle">
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <p className="text-gray-600 mb-6">
            Contact Suburban Construction for a free estimate on basement window
            replacement throughout the Quad Cities area.
          </p>
          <Link
            href="/contact"

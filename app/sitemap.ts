...
const staticPages = [
  ...
  { path: '/siding/siding-replacement-cost', priority: 0.8, changeFreq: 'monthly' },
  { path: '/siding/steel-vs-vinyl-siding', priority: 0.7, changeFreq: 'monthly' },
  { path: '/siding/vinyl-vs-composite-siding', priority: 0.7, changeFreq: 'monthly' },
  // Doors
  ...
  { path: '/doors/door-installation-cost', priority: 0.7, changeFreq: 'monthly' },
  // Gutters
  ...
  { path: '/gutters/gutter-installation-cost', priority: 0.7, changeFreq: 'monthly' },
  // About
